...
class SumOf3Numbers
{
    static void Main()
    {
        ...
        double a = Nakov.IO.Cin.NextDouble();
        double b = Nakov.IO.Cin.NextDouble();
        double c = Nakov.IO.Cin.NextDouble();
        double d = Nakov.IO.Cin.NextDouble();
        double e = Nakov.IO.Cin.NextDouble();
